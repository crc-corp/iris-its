...
/**
 * DataPlotExceptionDialog
 *
 * @author Tim Johnson
 */
public final class DataPlotExceptionDialog extends JDialog {

	/** Vertical box for components in the exception dialog */
	protected final Box box;

	/** Create a new ExceptionDialog */
	public DataPlotExceptionDialog( final Exception e ) {
	...
	protected void addAssistanceMessage() {
		...
		addText( "DataPlot system administrator." );
	}

	/** Send an e-mail alert to the system administrators */
	protected void sendEmailAlert( Exception e ) {
		String host = "www.dot.state.mn.us";
		String from = "DataPlot@dot.state.mn.us";
		try {
			InternetAddress to[] = {
			...
			message.setSubject( "DataPlot Exception" );
