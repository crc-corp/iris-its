...
/**
  * DataFile30Second
  *
  * This is the class for reading 30-second detector data from
  ...
  */
public final class DataFile30Second extends DataFile {
	...
	/** Open a 30-second traffic data file read-only */
	public DataFile30Second( String fileName ) throws IOException {
		super( fileName );
